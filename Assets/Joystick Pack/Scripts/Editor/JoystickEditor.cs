...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty fakehandle;
    ...
    protected virtual void OnEnable()
    {
        ...
        fakehandle = serializedObject.FindProperty("fakehandle");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (fakehandle != null)
        {
            RectTransform fakehandleRect = (RectTransform)fakehandle.objectReferenceValue;
            fakehandleRect.anchorMax = center;
            fakehandleRect.anchorMin = center;
            fakehandleRect.pivot = center;
            fakehandleRect.anchoredPosition = Vector2.zero;
        }
    }
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.ObjectField(fakehandle, new GUIContent("fakehandle", "The handle's RectTransform component."));
    }
}